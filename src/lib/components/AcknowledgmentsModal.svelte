<script lang="ts">
	import AcknowledgmentsContent from '$lib/content/AcknowledgmentsContent.svelte';
...
>
	<div class="bg-gray-800 rounded-xl p-6 max-w-md w-full mx-4 shadow-2xl border border-gray-700">
		<div class="flex justify-between items-center mb-6">
			<h2 id="modal-title" class="text-xl font-bold text-amber-100">{t('acknowledgments.title')}</h2>
			<button
				onclick={onClose}
