...
We pray to Allah ﷻ for the success of this project and for it to be beneficial to all who use it.

This project was inspired by:

- [Tarteel AI - Quran Companion](https://tarteel.ai)
...
- [Quran Majeed](https://quranmajeed.com)
  - The bookmarking and saving of last reading position was inspired by the QuranMajeed app.

Speech recognition powered by the [Web Speech API](https://developer.mozilla.org/en-US/docs/Web/API/Web_Speech_API).
