import type { Surah, GlobalHighlightedWords, GlobalVerseKey, LookupMaps } from '../types';
import { toGlobalKey, getNextVerse, findVerseIndex } from '../utils/globalAddressing';
